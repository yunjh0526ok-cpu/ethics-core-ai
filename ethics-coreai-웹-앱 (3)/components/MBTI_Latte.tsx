  ...
  return (
    <section id="fun-zone" className="relative z-10 py-24 px-4 w-full max-w-7xl mx-auto border-t border-slate-800">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        {/* ================= LEFT: MBTI DIAGNOSIS (QUIZ MODE) ================= */}
        <motion.div 
            initial={{ opacity: 0, x: -30 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="bg-[#0a0a12] border border-slate-800 rounded-3xl p-8 relative overflow-hidden flex flex-col min-h-[600px]"
        >
                            ...
                            <div className="grid gap-4">
                                {QUIZ_QUESTIONS[quizStep].options.map((opt, idx) => (
                                    <button
                                        ...
                                        className="p-6 rounded-2xl bg-slate-900 border border-slate-700 hover:border-cyber-purple hover:bg-slate-800 transition-all text-left group relative overflow-hidden"
                                    >
                            ...
                            >
                                ...
                                <div className="flex-grow overflow-y-auto custom-scrollbar pr-2 space-y-4">
                                    ...
                                    <div className="grid grid-cols-1 gap-4">
                                        ...
                                        <div className="bg-slate-950/50 p-4 rounded-xl border-l-4 border-green-500">
                                    ...
                                    <div className="bg-gradient-to-r from-slate-800 to-slate-900 border border-slate-600/50 rounded-xl p-4 shadow-lg relative overflow-hidden group">
        ...
        {/* ================= RIGHT: LATTE TRANSLATOR (AI) ================= */}
        <motion.div 
            initial={{ opacity: 0, x: 30 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="bg-[#0a0a12] border border-slate-800 rounded-3xl p-8 relative overflow-hidden flex flex-col"
        >
             ...
             <div className="flex-grow flex flex-col gap-4">
                 ...
                 <div className="relative">
                     ...
                     <textarea
                        ...
                        className="w-full h-28 bg-slate-900 border border-slate-700 rounded-xl p-4 text-white focus:border-yellow-500 focus:outline-none resize-none placeholder:text-slate-600 custom-scrollbar"
                     />
                 </div>
                 ...
                 <div className="relative flex-grow min-h-[140px]">
                     ...
                     <div className="w-full h-full bg-gradient-to-br from-slate-900 to-[#1a1500] border border-yellow-900/30 rounded-xl p-6 flex flex-col relative overflow-hidden">
                 ...
                 <div className="mt-2 pt-4 border-t border-slate-800">
                     ...
                     <div className="grid grid-cols-1 gap-2">
                         <div className="bg-slate-800/80 p-3 rounded-lg border border-slate-700 hover:border-green-500/50 transition-colors">
                             <strong className="text-green-400 text-xs block mb-1">To. 상사님</strong>
                             <p className="text-slate-300 text-xs leading-snug">
                                {actionPlan.manager}
                             </p>
                         </div>
                         <div className="bg-slate-800/80 p-3 rounded-lg border border-slate-700 hover:border-cyber-accent/50 transition-colors">
